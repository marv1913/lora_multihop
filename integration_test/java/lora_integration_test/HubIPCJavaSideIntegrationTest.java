...
public class HubIPCJavaSideIntegrationTest {
    ...
    public void stage01RegisterUnregisterPeers() throws IOException, InterruptedException {
        ...
        hubIPCJavaSideA.register(this.peerIdA, null);
        // register Bob on second IPC instance
        hubIPCJavaSideB.register(this.peerIdB, null);
    ...
    public void StringInput() throws IOException {
        ...
        System.out.println(stringInputStream.read());
    }
    ...
    private class ConnectorInternalLocalStub implements ConnectorInternal {
