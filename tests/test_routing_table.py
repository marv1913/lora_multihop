...
class RoutingTableTest(unittest.TestCase):
    ...
    def test_get_best_route_of_all_available_destinations(self):
        self.routing_table.routing_table = [{'destination': '0131', 'next_node': '0131', 'hops': 1},
                                            {'destination': '0131', 'next_node': '0132', 'hops': 2}]
        self.assertEqual([{'destination': '0131', 'next_node': '0131', 'hops': 1}],
                         self.routing_table.get_list_of_best_routes_for_all_available_destinations())
